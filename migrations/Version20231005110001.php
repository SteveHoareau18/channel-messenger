 ...
 */
final class Version20231005110001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(155) NOT NULL, firstname VARCHAR(155) DEFAULT NULL, lastname VARCHAR(155) DEFAULT NULL, create_date DATETIME NOT NULL, last_connection_date DATETIME DEFAULT NULL, email_verification_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
